...
--> statement-breakpoint
CREATE TABLE "foodia"."store_tags" (
	"id" bigserial PRIMARY KEY NOT NULL,
...
--> statement-breakpoint
CREATE TABLE "foodia"."tags" (
	"id" bigserial PRIMARY KEY NOT NULL,
	"name" varchar(50) NOT NULL,
	"type" varchar(20) NOT NULL,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "tags_type_check" CHECK ("foodia"."tags"."type" IN ('category', 'purpose', 'feature'))
);
--> statement-breakpoint
...
ALTER TABLE "foodia"."store_tags" ADD CONSTRAINT "store_tags_tag_id_tags_id_fk" FOREIGN KEY ("tag_id") REFERENCES "foodia"."tags"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "foodia"."store_tags" ADD CONSTRAINT "store_tags_rid_stores_rid_fk" FOREIGN KEY ("rid") REFERENCES "foodia"."stores"("rid") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "store_tags_idx_tag_id" ON "foodia"."store_tags" USING btree ("tag_id");--> statement-breakpoint
CREATE INDEX "store_tags_idx_rid" ON "foodia"."store_tags" USING btree ("rid");--> statement-breakpoint
CREATE UNIQUE INDEX "store_tags_unique_rid_tag" ON "foodia"."store_tags" USING btree ("rid","tag_id");--> statement-breakpoint
CREATE INDEX "tags_idx_name" ON "foodia"."tags" USING btree ("name");--> statement-breakpoint
CREATE INDEX "tags_idx_type" ON "foodia"."tags" USING btree ("type");--> statement-breakpoint
CREATE UNIQUE INDEX "tags_unique_name_type" ON "foodia"."tags" USING btree ("name","type");--> statement-breakpoint
